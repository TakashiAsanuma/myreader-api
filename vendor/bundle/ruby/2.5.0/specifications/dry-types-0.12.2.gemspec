...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dry-logic>.freeze, [">= 0.4.2", "~> 0.4"])
      s.add_runtime_dependency(%q<inflecto>.freeze, [">= 0.0.2", "~> 0.0.0"])
      ...
      s.add_dependency(%q<dry-logic>.freeze, [">= 0.4.2", "~> 0.4"])
      s.add_dependency(%q<inflecto>.freeze, [">= 0.0.2", "~> 0.0.0"])
